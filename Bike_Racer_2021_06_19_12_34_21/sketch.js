...
// Moving background
path=createSprite(windowWidth,windowHeight-300,600,20);
path.addImage(pathImg);
path.velocityX = -5;
path.x = path.width/2;

//creating boy running
mainCyclist  = createSprite(windowWidth,windowHeight-300,20,50);
mainCyclist.addAnimation("SahilRunning",mainRacerImg1);
mainCyclist.scale=0.15;
mainCyclist.x = mainCyclist.width/4
